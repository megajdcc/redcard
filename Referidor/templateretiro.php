								...
								<tr>
									<td valign="top" align="center">
										<a href="'.HOST.'" target="_blank">
											<img alt="Travel Points" src="<?php echo HOST.'/assets/img/logo-redcard.png';?>" style="padding-bottom: 0; display: inline !important;">
										</a>
									</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								<tr>
									<td class="tablepadding" align="center" style="color: #444; padding:10px; font-size:14px; line-height:20px;">
										Nueva Solicitud de retiro de comision del referidor <?php echo $this->getNameReferidor();?>.
							...
							<tr>
								<td style="padding-right:10px; padding-bottom:9px;">
									<a href="https://www.facebook.com/eSmart-Club-130433773794677" target="_blank" style="text-decoration:none; outline:none;">
										<img src="<?php echo HOST.'/assets/img/facebook.png'?>" width="32" height="32" alt="Facebook">
									</a>
								</td>
							</tr>
						</table>
