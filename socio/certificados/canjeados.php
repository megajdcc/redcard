...
$redeemed = new socio\libs\user_redeemed($con);
...
$properties['title'] = 'Mis certificados de regalo canjeados | Travel Points';
				...
				<div class="row">
					...
					<div class="col-sm-8 col-lg-9">
						<div class="content">
							...
							<div class="page-title"><?php echo $redeemed->get_count();?></div>
