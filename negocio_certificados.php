...
$business = new assets\libs\business_certificates($con);
...
$properties['title'] = 'Opiniones | '.$business->get_raw_name().' | Travel Points';
		...
		<div class="content">
			...
			<div class="container">
				...
				<div class="row detail-content">
					<div class="col-sm-9">
						<?php echo $business->get_certificates(); echo $paging->parse(); ?>
					</div>
					<div class="col-sm-3">
