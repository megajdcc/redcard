		...
		<div class="content">
			<div class="mt-80">
				<div class="document-title">
					<h1 class="text-binary">T&eacute;rminos y Condiciones</h1>
				</div><!-- /.document-title -->
			</div>
			<div class="container">
				...
				<div class="background-white p30 terms-conditions text-default">
					<ol>
						...
						<li><h4 class="text-secondary">Limitaci&oacute;n de responsabilidad</h4>
							...
							<ul>
								...
								<li>
									Por los contenidos que los usuarios incorporen en el Sitio Web.
								</li>
							</ul>
						</li>
						...
						<li><h4 class="text-secondary">Negocios afiliados</h4>
							<p>
								Los Negocios Afiliados se afilian libremente al club, sin embargo estar afiliado no es una garant&iacute;a para el socio, por lo que eSmartClub.com conmina a sus usuarios a investigar y consultar las advertencias, prohibiciones, anuncios y avisos emitidos por los dem&aacute;s socios, y tomar las precauciones que har&iacute;an en condiciones normales de consumo.
							</p>
							<ol>
								<li><h4 class="text-secondary">Registro de Consumos</h4>
									<p>
										Los Negocios Afiliados se obligan a registrar los consumos que realicen los socios del club en el negocio, y que se identifiquen como socio de cualquier manera ya sea un medio f&iacute;sico (tarjeta), virtual, electr&oacute;nico o simplemente mencionando el nombre de su usuario. Negar el registro de un consumo podr&aacute; interpretarse como una violaci&oacute;n a los T&eacute;rminos y Condiciones del presente contrato y pudiera afectar negativamente la reputaci&oacute;n del Negocio Afiliado e incluso dar lugar a la cancelaci&oacute;n de la cuenta, y ser publicado como un negocio que incumple con los consumidores.
									</p>
								</li>
								...
								<li><h4 class="text-secondary">Certificados de Regalo</h4>
									<p>
										La publicaci&oacute;n de Certificados de Regalo para atraer socios compradores a su Negocio Afiliado es libre, pero debe tomarse con la responsabilidad que amerita, ya que deber&aacute;n ser respetados &iacute;ntegramente. Los malos usos, enga&ntilde;os, o publicidad enga&ntilde;osa a trav&eacute;s de cualquiera de las herramientas disponibles en el Sitio Web podr&aacute;n generar denuncias a su sitio y repercutir en su reputaci&oacute;n, y en su caso pudieran dar lugar a la cancelaci&oacute;n de su cuenta.
									</p>
									<p>
										El negocio podr&aacute; publicar libremente sus certificados de regalo, el valor de los mismos, las condiciones y las restricciones de uso y tambi&eacute;n el n&uacute;mero de certificados que desea otorgar en el lapso que defina.
									</p>
									<p>
										Los usuarios podr&aacute;n agregar estos certificados a su lista de deseos y ver&aacute;n el n&uacute;mero de certificados disponible en la medida que estos se consuman.
									</p>
									<p>
										Si el usuario llega al negocio ya que se acabaron, pues ya valio.
									</p>
									<p>
										El Sitio Web muestra de manera autom&aacute;tica los certificados disponibles de cada negocio, y el Negocio deber&aacute; otorgarlo mientras tenga disponibilidad en el sitio.
									</p>
									<p>
										El Negocio podr&aacute; publicar tantos certificados como guste, editarlos o eliminarlos, pero deber&aacute; otorgarlos a las personas que durante la vigencia los hayan solicitado.
									</p>
								</li>
							</ol>
						</li>
						<li><h4 class="text-secondary">Rese&ntilde;as, comentarios y el uso de otras &aacute;reas interactivas</h4>
							<p>
								El Sitio Web est&aacute; dise&ntilde;ado para que los usuarios generen opiniones y recomendaciones de los Negocios Afiliados con el objetivo de mejorar la satisfacci&oacute;n de las experiencias de compra de los socios del club.
							</p>
							<p>
							...
							<p>
								El Sitio puede contener foros de discusi&oacute;n, tablero de mensajes, servicios de rese&ntilde;as u otros foros en los que usted o terceras personas pueden colocar rese&ntilde;as de experiencias de compras u otros contenidos, mensajes, materiales u otros art&iacute;culos en el Sitio Web ("&aacute;reas Interactivas"). Si eSmartClub.com provee estas &aacute;reas Interactivas, usted las puede usar bajo su propio riesgo, siendo responsabilidad exclusiva de usted el uso que haga de las mismas. Al usar las &aacute;reas Interactivas, de manera expresa acepta no colocar, subir a, transmitir, distribuir, almacenar, crear o de cualquier otra manera publicar en el Sitio:
							</p>
							<p>
								(1) Mensajes, datos, informaci&oacute;n, texto, m&uacute;sica, sonido, fotos, gr&aacute;ficos, c&oacute;digos o cualquier otro material ("Contenido") il&iacute;cito, inmoral, difamatorio, obsceno, pornogr&aacute;fico, indecente, sugestivo, denigrante, intimidatorio, que vulnere derechos a la privacidad o informaci&oacute;n, abusivos, fraudulentos o de cualquier otra manera objetables; (2) contenido que pudiere constituir, fomentar o proporcionar instrucciones para la comisi&oacute;n de un delito, violar los derechos de un tercero o que de cualquier otra manera pudiere generar una responsabilidad o violar leyes internacionales, federales, estatales o municipales. (3) Contenido que pudiera ser violatorio de patentes, marcas, secretos comerciales, derechos de autor o derechos de propiedad intelectual de terceros; (4) Contenido que imite a una persona, f&iacute;sica o moral, o que de cualquier otra manera falsamente represente su afiliaci&oacute;n con una persona, f&iacute;sica o moral, incluyendo eSmartClub.com; (5) Campa&ntilde;as pol&iacute;ticas, anuncios, concursos, rifas o promociones no solicitadas; (6) Informaci&oacute;n personal de terceros, incluyendo, pero no limitado a apellidos, domicilio, n&uacute;mero telef&oacute;nico, direcci&oacute;n de correo electr&oacute;nico, n&uacute;mero de Seguridad Social o de identificaci&oacute;n fiscal, n&uacute;mero de tarjeta de cr&eacute;dito; (7) Virus, datos corruptos u otros archivos destructivos o da&ntilde;inos; (8) Contenido que no guarde relaci&oacute;n con el tema del &aacute;rea Interactiva en donde se coloque o publique dicho Contenido; o (9) Contenido o ligas a contenido que a solo juicio de eSmartClub.com (a) viole cualquiera de los incisos anteriores, (b) sea cuestionable, (c) restrinja o inhiba a otras personas usar o disfrutar el &aacute;rea Interactiva o el Sitio, o (d) pudiere exponer a eSmartClub.com o sus afiliados o sus usuarios a da&ntilde;os o responsabilidades de cualquier naturaleza.
							</p>
							<p>
								eSmartClub.com no asume obligaci&oacute;n o responsabilidad alguna respecto al Contenido colocado, publicado, almacenado o subido por usted o un tercero, o bien, respecto a da&ntilde;os o perjuicios por tales motivos. eSmartClub.com no es responsable por errores, calumnias, difamaciones, omisiones, falsedades, obscenidades, pornograf&iacute;a, vulgaridades o actos similares que usted pudiere encontrar. Como un proveedor de servicios interactivos, eSmartClub.com no es responsable de las declaraciones, garant&iacute;as o Contenido proporcionado por los usuarios en foros p&uacute;blicos, p&aacute;gina personal o &aacute;rea Interactiva. A pesar que eSmartClub.com no tiene obligaci&oacute;n alguna de filtrar, editar o monitorear el Contenido colocado, publicado o distribuido en el &aacute;rea Interactiva, eSmartClub.com se reserva el derecho, a su solo juicio, en cualquier momento y por cualquier causa, de remover, filtrar o editar el Contenido colocado, publicado o almacenado en el Sitio Web. Usted, bajo su propio costo y responsabilidad, es responsable de respaldar y reemplazar el Contenido que coloque, publique o almacene en el Sitio.
							</p>
							<p>
								Si se llegara a determinar que usted conserva derechos morales relacionados con el Contenido (incluyendo derechos de autor&iacute;a o integridad), en este acto usted manifiesta que (a) no requiere que se utilice su informaci&oacute;n personal sea utilizada en relaci&oacute;n con el Contenido o cualquier derivado o actualizaci&oacute;n del Contenido; (b) no tiene inconveniente alguno en que se publique, use, modifique, elimine o explote el Contenido por parte de eSmartClub.com, sus licenciatarios, sucesores o cesionarios; (c) renuncia y acepta no reclamar, a perpetuidad, la titularidad de los derechos morales de autor respecto al Contenido; y (d) libera a eSmartClub.com, sus licenciatarios, sucesores o cesionarios, a perpetuidad, de cualquier reclamaci&oacute;n que pudiere tener en su contra en relaci&oacute;n con los derechos morales de autor.
							</p>
							<p>
								El uso del &aacute;rea Interactiva u otras partes del Sitio en violaci&oacute;n de lo anterior, constituye una violaci&oacute;n a los T&eacute;rminos del Sitio y puede conllevar, entre otras cuestiones, a la suspensi&oacute;n o terminaci&oacute;n de sus derechos para usar el &aacute;rea Interactiva y el Sitio Web. eSmartClub.com podr&aacute; tener acceso y divulgar aquella informaci&oacute;n que considere necesaria o conveniente, incluyendo, pero no limitado a la informaci&oacute;n del perfil del usuario (por ejemplo nombre, correo electr&oacute;nico, etc.), direcci&oacute;n IP e informaci&oacute;n de tr&aacute;fico, historial y Contenido colocado o publicado en el Sitio, con la finalidad de cooperar con solicitudes leg&iacute;timas de las autoridades u &oacute;rdenes judiciales, para proteger a los clientes y sistemas de eSmartClub.com, o para efectos de garantizar la integridad y operaci&oacute;n de eSmartClub.com y sus sistemas. El derecho de eSmartClub.com para divulgar dicha informaci&oacute;n prevalecer&aacute; sobre los t&eacute;rminos y condiciones de las Pol&iacute;ticas de Privacidad de eSmartClub.com.
							</p>
						</li>
						<li><h4 class="text-secondary">eSmartties (puntos)</h4>
							<p>
						...
						<li><h4 class="text-secondary">Cookies</h4>
							<p>
								El acceso a este Sitio Web puede implicar la utilizaci&oacute;n de cookies. Las cookies son peque&ntilde;as cantidades de informaci&oacute;n que se almacenan en el navegador utilizado por cada usuario para que el servidor recuerde cierta informaci&oacute;n que posteriormente &uacute;nicamente el servidor que la implement&oacute; leer&aacute;. Las cookies tienen, generalmente, una duraci&oacute;n limitada en el tiempo. Ninguna cookie de este Sitio Web permite que pueda contactarse con el n&uacute;mero de tel&eacute;fono del usuario, su direcci&oacute;n de correo electr&oacute;nico o con cualesquiera otro medio de contacto. Ninguna cookie de este Sitio Web puede extraer informaci&oacute;n del disco duro del usuario o almacenar datos personales. La &uacute;nica manera, en este Sitio Web, de que la informaci&oacute;n privada de un usuario forme parte del archivo cookie es que el usuario d&eacute; personalmente esa informaci&oacute;n al servidor. Aquellos usuarios que no deseen recibir cookies o quieran ser informados de su fijaci&oacute;n pueden configurar su navegador a tal efecto. En el caso de que se eliminen las cookies, la calidad y rapidez del servicio puede disminuir.
							</p>
						</li>
						...
						<li><h4 class="text-secondary">Jurisdicci&oacute;n y fuero aplicable</h4>
							<p>
								Los conflictos que puedan surgir por la aplicaci&oacute;n de las presentes normas se regular&aacute;n por las leyes del Estado de Jalisco, M&eacute;xico y ser&aacute;n resueltos por los tribunales competentes en la ciudad de Puerto Vallarta, Jalisco, renunciando expresamente los usuarios sean compradores o negocios afiliados a cualquier otra jurisdicci&oacute;n que pudiera corresponderles en virtud de su domicilio actual o futuro.
							</p>
						</li>
						<li><h4 class="text-secondary">Varios</h4>
							<p>
								En el supuesto de que cualquier cl&aacute;usula del presente Aviso Legal fuera anulada o considerada nula, el resto de condiciones no se ver&aacute;n afectadas, conservando plenamente su validez y vigencia. 
							</p>
						</li>
						<li><h4 class="text-secondary">Asistencia</h4>
							<p>
								Consultenos cualquier duda a trav&eacute;s del Sitio Web o p&oacute;ngase en contacto en:<br>
								eSmartClub<br>
								Marina Vallarta Business Center, oficina 204<br>
								Plaza Marina, Fraccionamiento Marina Vallarta<br>
								Puerto Vallarta, Jalisco, M&eacute;xico<br>
								Tel: (322) 225 9635<br>
