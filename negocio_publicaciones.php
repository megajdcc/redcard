...
$business = new assets\libs\business_posts($con);
...
$paging->setRPP($rpp);
$paging->setCrumbs(10);
$paging->setTarget('/alan-coffee-shop/publicaciones/');
$paging->setKey('');

$includes = new assets\libs\includes($con);
$properties['title'] = 'Publicaciones | '.$business->get_raw_name().' | Travel Points';
		...
		<div class="content">
			...
			<div class="container">
				...
				<div class="row detail-content">
					<div class="col-sm-9">
						<?php echo $business->get_posts(); echo $paging->parse(); ?>
					</div>
					<div class="col-sm-3">
