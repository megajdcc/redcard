	...
	<div class="main-inner">
		<div class="content">
			...
			<div class="container">
				...
				<div>
					<!-- <img class="img-responsive mb30" src="<?php echo HOST;?>/assets/img/travelpoints/monedero-travel-points.jpg" alt="Monedero en Travel Points"> -->
					<img class="img-responsive mb30" src="<?php echo HOST;?>/assets/img/travelpoints/encuentra-travelpoints.jpg" alt="Encuentra negocios que den eSmartties en Travel Points">
					<a href="<?php echo HOST;?>/tienda/"><img class="img-responsive mb80" src="<?php echo HOST;?>/assets/img/travelpoints/adquiere-regalos-travel-points.jpg" alt="Adquiere Regalos en Travel Points"></a>
				</div>
				<div class="posts post-detail">
					<div class="post-content">
						<img class="post-content-image pull-left" src="<?php echo HOST;?>/assets/img/travelpoints/esmart-club-logo.png" alt="Regalos en Travel Points" style="width:100px;height:auto;margin-top:-30px;">
						<p>
						...
						<img class="post-content-image pull-left" src="<?php echo HOST;?>/assets/img/travelpoints/esmart-club-clientes.jpg" alt="Clientes en Travel Points">
						...
						<p>
							La afiliaci&oacute;n a travel Points es gratuita.
						</p>
						<p>
