            ...
            <h3 class="page-title">Informaci&oacute;n de hotel</h3>
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                      ...
                      <div class="form-group" data-toggle="tooltip" title="Los clientes de Travel Points pueden hospedarse desde su propio perfil...">
                        <label for="business-name">Nombre del hotel <span class="required"></span> <i class="fa fa-question-circle text-secondary"></i></label>

                        <input class="form-control" type="text" id="business-name" name="nombrehotel" value="<?php echo $affiliate->getNombreHotel();?>" placeholder="Nombre del hotel"/>
                        <?php echo $affiliate->getNombreHotelError();?>
                      </div><!-- /.form-group -->
                        ...
                        <div class="col-lg-8">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input class="form-control" type="text" id="address" name="direccion" value="<?php echo $affiliate->getDireccion();?>" placeholder="Direcci&oacute;n del hotel">
                            </div><!-- /.input-group -->
                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select class="form-control" id="country-select" name="pais" title="Selecciona un pa&iacute;s" data-size="10" data-live-search="true">
                        ...
                        <div class="col-lg-4">
                          <div class="form-group">
                            ...
                            <select class="form-control" id="state-select" name="estado" title="Luego un estado" data-size="10" data-live-search="true">
        ...
        <div class="background-white p30 mb50">
         ...
         <div class="row">
            ...
            <div class="form-group" data-toggle="tooltip" title="Confirmanos tu Email">
               ...
               <div class="input-group">
                 <span class="input-group-addon"><i class="fa fa-file"></i></span>
                 <input class="form-control" type="email"  id="emailfranquiciatario" name="emailfranquiciatario" value="<?php echo $affiliate->getEmailFranquiciatario();?>" placeholder="Email Franquiciatario" >
               </div>
               
               <?php echo $affiliate->getEmailFranquiciatarioError();?>
            </div>
