												...
												<div class="row">
														...
														<div class="col-sm-6">
															<div class="input-group">
																...
																<input class="form-control" type="text" id="input-latitude"  name="latitud" value="" placeholder="Latitud" >
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="input-group">
																<span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
																<input class="form-control" type="text" id="input-longitude" name="longitud" value="" placeholder="Longitud" >
															</div>
														</div>
									        ...
									        <div class="col-lg-6">
									            <div class="form-group" data-toggle="tooltip" title="Tu nombre">
									               ...
									               <div class="input-group">
									                 ...
									                 <input class="form-control" type="text" id="nombre" name="nombrecontacto" value="" placeholder="Nombre" required>
									               </div>
									            ...
									            <div class="form-group" data-toggle="tooltip" title="Tu Apellido">
									               ...
									               <div class="input-group">
									                 <span class="input-group-addon"><i class="fa fa-file"></i></span>
									                 <input class="form-control" type="text"  id="apellido" name="apellidocontacto" value="" placeholder="Apellido" required>
									               </div>
				...
				$('.actualizarperfil').click(function(){
					...
					.done(function(response) {
						...
						var codigohotel = '';
							...
							$('.eliminar').change();
							$('#nombrehotel').attr('value', response.datos.nombrehotel);
							
							$("#iata option[value='"+response.datos.id_iata+"']").attr('selected', true);
							$("#iata").change();
							
							$("input[name='website']").val(response.datos.sitioweb);
							$("input[name='direccion']").val(response.datos.direccion);
							$("input[name='codigopostal']").val(response.datos.codigopostal);
							...
							$('input[name="nombrecontacto"]').val(response.datos.nombre);
							$('input[name="apellidocontacto"]').val(response.datos.apellido);
							...
							$('.title-modal-hotel').html('Hotel '+ response.datos.nombrehotel);
						...
						if(response.datos.codigo == 'ninguna' || response.datos.codigo == 'Ninguna' ){
							if($('.generarcodigo')){
							...
							$('.crearcodigo').attr('data-hotel', response.datos.nombrehotel);
