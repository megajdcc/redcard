							...
							<div class="header-nav-user">
								<div class="dropdown">
									<button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
										...
										<span class="header-nav-user-name">Hotel</span> <i class="fa fa-chevron-down"></i>
									</button>
									...
									$html .= '<li><a href="'.HOST.'/admin/">Panel eSmart Club</a></li>
										...
										<li><a href="'.HOST.'/admin/franquicitario/">Panel Franquicitario</a></li>
										<li><a href="'.HOST.'/admin/referidor/">Panel Referidor</a></li>';
									if($this->admin['pending_request'] > 0){
