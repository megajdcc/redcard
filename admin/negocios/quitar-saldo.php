	...
	<div class="col-sm-12">
		...
		<form method="post" action="<?php echo _safe(HOST.'/admin/negocios/quitar-saldo');?>">
			<div class="background-white p30 mb50">
				...
				<div class="row">
					<div class="col-md-8">
						<div class="form-group" id="business-search" data-toggle="tooltip" title="Ingrese el nombre del negocio o la url del negocio afiliado a eSmart Club al que desea quitarle saldo. Verifique su coincidencia cuidadosamente.">
