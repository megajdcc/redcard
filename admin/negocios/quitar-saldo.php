...
$balance = new admin\libs\remove_balance_business($con);

if($_SERVER["REQUEST_METHOD"] == "POST"){
	if(isset($_POST['remove'])){
		$balance->remove_balance($_POST);
	}
}

$includes = new admin\libs\includes($con);
$properties['title'] = 'Quitar saldo | eSmart Club';
...
<div class="row">
	<div class="col-sm-12">
		...
		<form method="post" action="<?php echo _safe(HOST.'/admin/negocios/quitar-saldo');?>">
			<div class="background-white p30 mb50">
				<div class="page-title">
					<h4>Quitar saldo a un negocio</h4>
				</div>
				<div class="row">
					<div class="col-md-8">
						<div class="form-group" id="business-search" data-toggle="tooltip" title="Ingrese el nombre del negocio o la url del negocio afiliado a Travel Points al que desea quitarle saldo. Verifique su coincidencia cuidadosamente.">
					...
					<div class="col-md-4">
						<div class="form-group" data-toggle="tooltip" title="Escriba la cantidad sin signos o comas. Utilice punto decimal si es necesario.">
							<label for="withdraw-balance">Cantidad de saldo a quitar <i class="fa fa-question-circle text-secondary"></i></label>
							<input class="form-control" type="text" id="withdraw-balance" name="balance" value="<?php echo $balance->get_balance();?>" placeholder="Cantidad a quitar" required/>
				...
				<hr>
				<button class="btn btn-success" type="submit" name="remove">Quitar saldo</button>
			</div>
		</form>
	</div>
</div>
