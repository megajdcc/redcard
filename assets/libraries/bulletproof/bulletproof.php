 ...
 * @license     MIT
 */
namespace assets\libraries\bulletproof;
...
class bulletproof implements \ArrayAccess
{
     ...
     */
    protected $size = array(1024, 2097152);

    /**
     * @var array The max height and width image allowed
     */
    protected $dimensions = array(3264, 3264);
    ...
    private $error_messages = array(
		...
		'location'                  => "La subida falló debido a un error.",
		'mime_type'                 => "Tipo de imagen inválido. Solo se permiten imágenes con extension: %s.",
		'file_size'                 => "El tamaño de la imagen debe ser mayor que %sKB y menor que %sMB.",
		'dimensions'                => "Las dimensiones de la imagen deben ser menores que %s pixeles de alto y %s pixeles de ancho.",
		'too_small'                 => "El tamaño es muy pequeño o el archivo está corrupto.",
		'unknown'                   => "La subida falló debido a un error."
	);
    ...
    public function upload()
    {
        ...
        if ($files["size"] < $minSize || $files["size"] > $maxSize) {
            $min = round($minSize / 1024,2);
            $max = round($maxSize / 1048576,2);
