...
use Franquiciatario\models\Usuarios;
use Franquiciatario\models\Includes;
use Franquiciatario\models\NuevoUsuario;
...
<div class="main">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-sm-offset-2">
							...
							<form method="post" action="<?php echo _safe(HOST.'/Franquiciatario/usuarios/nuevousuario');?>" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										...
										<button type="submit" class="btn btn-primary pull-right" id="register-bHoteltn">Join | ¡Hazme Socio!</button>
									</div>
								</div>
							</form>
						</div><!-- /.col-sm-12 -->
